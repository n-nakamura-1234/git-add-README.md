...
<div id="primary" class="content-area">
	<main id="main" class="site-main">
		...
		<div class="linkArea">
			<ul class="linkArea__list">
				<li class="linkArea__item">
					<a class="linkArea__link" href="https://www.instagram.com/hakuryuko_resort/"><img src="https://hakuryuko-resort.co.jp/wp-content/uploads/2022/10/logo_instagram.png" alt="ロゴ"></a>
				</li>
				<li class="linkArea__item">
		...
		<div class="bannerArea">
			<div class="bannerArea__inner">
				<div class="top-banner-items">
					<?php $banner_items = SCF::get('banners', 744);
					foreach ($banner_items as $item) :
						$itemUrl = wp_get_attachment_image_src($item['top_banner'], 'full');
						if ($itemUrl !== '') :
					?>
							<div class="bannerArea__block2">
								<img src="<?php echo $itemUrl[0]; ?>" alt="">
							</div>
					<?php
						endif;
					endforeach; ?>
		...
		<script>
			jQuery(function($) {
				let target = $('.bannerArea__block2');
				if (target.length > 1) {

					$('.top-banner-items').slick({
						centerMode: true,
						centerPadding: '20%',
						autoplay: true,
						autoplaySpeed: 3000,
